...
carro.addPessoas = function(pessoas){
	...
	var cabemQuantasPessoas = carro.assentos - carro.quantidadePessoas;
	var pluralSingular = cabemQuantasPessoas === 1 ? 'pessoa' : 'pessoas';
	...
	if( totalPessoas > carro.assentos ){
		return 'Só cabe mais ' + cabemQuantasPessoas + ' ' + pluralSingular + '!';
	}
