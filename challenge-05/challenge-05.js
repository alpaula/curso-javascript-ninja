...
*/
var myVar = [ 'Anna', 26, false, null, 'Ninja' ];
...
*/
console.log( myFunction( myVar )[1] ) // 26
...
*/
var myVar2 = [ 'JS', 'Nija', true, 10, null ];
...
function book( nomeLivro ){
    var estante = { 
        'Harry Potter': {
            quantidadePaginas: 3517,
            autor: 'J.k Rowling',
            editora: 'Rocco'
        },
        'Jogos Vorazes': {
            quantidadePaginas: 1240,
            autor: 'Suzanne Collins',
            editora: 'Rocco'
        },
        'A Seleção': {
            quantidadePaginas: 	2672,
            autor: 'Julia Quinn',
            editora: 'Arqueiro'
        },
    };

    return !nomeLivro ? estante : estante[nomeLivro]
};
