(function () {
	...
	*/
	...
	//OU  console.log(every ? 'Sim, todos os estados tem mais de 7 letras!' : 'Nem todos os estados tem mais de 7 letras!')
	console.log('\nTodos os estados de `brasil` tem mais de 7 letras? ', result());
	// ?
